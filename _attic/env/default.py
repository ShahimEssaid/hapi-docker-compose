...
environ['HS_HAPI_HOME'] = environ.get('HS_HAPI_HOME', str(Path('hapi')))
environ['HS_HAPI_VERSION'] = environ.get('HS_HAPI_VERSION', '6.8.0')
...
environ['HS_HAPI_DB_HOST'] = environ.get('HS_HAPI_DB_HOST', 'postgres')
